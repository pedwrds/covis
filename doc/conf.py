...
# add covis package to path:
sys.path.insert(0, os.path.abspath(".."))


# -- Project information -----------------------------------------------------
project = "covis"
copyright = "2023, Hartree Centre - STFC"
author = "Paul Edwards <paul.edwards@stfc.ac.uk>"
...
html_logo = "./_static/UKRI_STFC_HARTREE_CENTRE_WHITETEXT_RGB.png"
# (located in `html_static_path`)
# add favicon
